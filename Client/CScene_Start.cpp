...
void CScene_Start::enter()
{
    ...
    CProp* Prop = Instantiate<CProp>(Vec2(400 + 1280, 300), LAYER_TYPE::PROP);
    ...
    CMonster* pMonster = new CAngel;
    pMonster->SetPos(Vec2(800+3840, 500));
    AddObject(pMonster, LAYER_TYPE::MONSTER);

    pMonster = new CAngel;
    pMonster->SetPos(Vec2(800 + 2560, 450));
    AddObject(pMonster, LAYER_TYPE::MONSTER);
    

    CEffect* effct = Instantiate<CEffect>(Vec2(640 + 5120, 360), LAYER_TYPE::PROP);
    effct->SetTypeBool(Effect::LIGHT);
    effct->GetCollider()->SetScale(Vec2(100, 600));
    effct->GetCollider()->SetOffset(Vec2(0, -300));
...
void CScene_Start::TileLoad()
{
    ...
    // + L"bin\\content"
    wcscat_s(szFilePath, L"bin\\content\\Save\\1");
